...
get the app created:
    ...
    $ heroku apps:create vittkosh
    Creating vittkosh... done, stack is cedar
    http://vittkosh.herokuapp.com/ | git@heroku.com:vittkosh.git
...
You can deploy the skeleton project immediately:
    ...
    [...]
    -----> Launching... done, v3
           http://vittkosh.herokuapp.com deployed to Heroku

    To git@heroku.com:vittkosh.git
     * [new branch]      master -> master

It's live! Hit it with `curl`:

    $ curl http://vittkosh.herokuapp.com
    ["Hello" :from Heroku]
...
Then you can launch the REPL:
    ...
    $ lein repl :connect http://$REPL_USER:$REPL_PASSWORD@vittkosh.herokuapp.com/repl
